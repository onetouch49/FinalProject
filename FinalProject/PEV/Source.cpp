...
@Brief Hello -- program to count occurrences of a number in a stored vector with, print the min number to max number on it, and print how many times duplicated.
@Author Mohamed Azad, Younis Shakir, Masoud Qubad, Naz Zana.
