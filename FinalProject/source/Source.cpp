...
@section intro_sec Introduction about using Count Occurence Program:
@brief Program to use count occurrences of a number in a sorted vector with, print the min number to max number on it, and print how many times duplicated.
@details Usage: run the program and input some value it keeps asking to input a value until you put a value less than 1.
